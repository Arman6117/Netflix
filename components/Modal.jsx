  ...
  return (
    ...
    >
      <>
        ...
        <button
          onClick={handleClose}
          className="modal_button absolute right-5 top-5 !z-40 h-9 w-9 border-none bg-[#181818] hover:bg-[#181818]"
        >
        ...
        <div className="relative pt-[56.25%]">
          ...
          <div className="absolute bottom-10 flex w-full items-center justify-between px-10">
            <div className="flex space-x-2">
              ...
              <button className="modal_button" onClick={handleList}>
                {addedToList ? (
        ...
        <div className="bg-[#181818] flex space-x-16 rounded-b-md px-10 py-8 ">
          <div className="space-y-6 text-lg">
            ...
            <div className="flex font-light flex-col gap-x-10 gap-y-4 md:flex-row ">
